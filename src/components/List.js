	...
	listItem (location) {
		return (
			<li key={location.id} 
				...
				<h2 className="restaurant-name" tabIndex="0" aria-labelledby="list item name">{location.name}</h2>
				<h3 className="restaurant-categories" aria-labelledby="listitem categories">{location.categories[0].title}</h3>
				<h3 className="restaurant address" aria-labelledby="list item address">{location.location.display_address[0]}<br/>
				{location.location.display_address[1]}</h3>
				<h3 className="restaurant phone number" aria-labelledby="list item phone number">{location.phone}</h3>
				<h3 className="restaurant availability" aria-labelledby="list item availability">
